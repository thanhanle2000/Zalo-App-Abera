    ...
    (this.options = A || {}),
      ...
      (this.add = function (A) {
        ...
        if (
          ...
          0 === (e = p((A = A || "h2, h3, h4, h5, h6"))).length)
        )
          return this;
        for (
          !(function () {
          ...
          if (this.hasAnchorJSLink(e[o])) d.push(o);
            ...
            else if (e[o].hasAttribute("data-anchor-id"))
              n = e[o].getAttribute("data-anchor-id");
            else {
              for (
            ...
            ((h = document.createElement("a")).className =
